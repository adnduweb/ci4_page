            ...
            <div class="row li_row form_output" data-type="text" data-field="<?= $field; ?>">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <?= form_textarea_spread([$field, 'content'], isset($builder->id_field) ? $builder->_prepareLang() : NULL, 'class="form-control lang textarea_click"', false, 'ckeditor', true); ?>
                    </div>
                </div>
                ...
                <?php } ?>
                <?= form_hidden('builder[' . $field . '][type]', 'textarea'); ?>
