            ...
            t = $("#kt_apps_pages_list_datatable").KTDatatable({
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        <a href="' + startUrl + '/public/pages/edit/' + t.id + '" class="kt-nav__link">\
                        <i class="kt-nav__link-icon flaticon2-contract"></i>\
                        <span class="kt-nav__link-text">' + _LANG_.edit + '</span>\
                        </a></li>';
                            if (t.id != '1') {
                                template += ' <li class="kt-nav__item">\
                            <a href="#" data-id="' + t.id + '" class="deleterowKtdatatable kt-nav__link">\
